		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<div class=" full text-center">
					...
					<button id="show-answers-on-dialog" class="btn btn-sm btn-danger top10 " name="show-answers"  ng-click="showAnswers();" ng-disabled="showAnswer" type="button" onclick="jQuery('#resultModal').modal('hide');">
