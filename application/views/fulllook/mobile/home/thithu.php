...
<div id="thithu" class="full" ng-controller="testSetListController">
	...
	<div class="container">
		<div class="row" ng-init="selectedTestSetPage = 0">
			...
			<div class="col-xs-6 clearfix" ng-repeat="testSet in testSets | orderBy: 'ordering'" ng-show="inPage($index, selectedTestSetPage, 4)">	
			...
			<div class="col-xs-12 text-center">
				<nav aria-label="Navigation">
					<ul class="pagination justify-content-center">
						<li class="page-item" ng-repeat="page in range(1, totalPage(testSets.length, 4), 1)" 
