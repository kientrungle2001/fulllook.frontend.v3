	...
	<div class="container mt-4 mb-3">
		<div class="main-shadow full p-3">
			...
			<div id="guide" class="full bg-light p-3 mb-3">
				...
				<h5 class="text-center t-weight">Phần mềm FullLook giá <span class="label label-danger ">700.000
					...
					<div class="col-md-11">
						<ul>
							<li>Cách 1: Đặt mua thẻ FullLook <a class="font-weight-bold" href="#ordercardfl"> Tại
									đây</a></li>
							<li>Cách 2: Thanh toán bằng chuyển khoản ngân hàng <a class="font-weight-bold"
									href="#bankfl"> Tại đây</a></li>
