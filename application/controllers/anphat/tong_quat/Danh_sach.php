...
class Danh_sach extends MY_Action
{
  public function execute($luoc_do = 'tong_quat')
  {
    ...
    $data = [
      ...
      'model_nut_nhap_du_lieu' => 'chuyen_trang(\'/tong_quat/'.$luoc_do['ma_luoc_do'].'/nhap_du_lieu\')()',
      'model_nut_xuat_du_lieu' => 'chuyen_trang(\'/tong_quat/'.$luoc_do['ma_luoc_do'].'/xuat_du_lieu\')()',
      'du_lieu_tai_tu_dong' => [],
      'truong_danh_sach' => [],
      'truong_loc' => [],
      'truong_them_sua' => []
