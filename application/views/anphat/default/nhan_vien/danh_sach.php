...
<table class="table table-sm table-bordered">
  ...
  <tr ng-repeat="ban_ghi in danh_sach_ban_ghi">
    <td>{{$index + 1}}</td>
    <td>{{ban_ghi.ten_nhan_vien}}</td>
    <td>{{ban_ghi.ma_nhan_vien}}</td>
    <td>{{ban_ghi.ten_dang_nhap}}</td>
    ...
    <td>
      <a href="#" class="fa fa-pencil text-primary" ng-click="mo_dialog_sua_ban_ghi(ban_ghi, 'nhan_vien_modal')"></a>
