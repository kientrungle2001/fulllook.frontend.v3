...
<table class="table table-sm table-bordered">
  ...
  <tr ng-repeat="ban_ghi in danh_sach_ban_ghi">
    <td>{{$index + 1}}</td>
    <td>{{ban_ghi.ten_loai_dich_vu}}</td>
    <td>{{ban_ghi.ma_loai_dich_vu}}</td>
    ...
    <td>
      <a href="#" class="fa fa-pencil text-primary" ng-click="mo_dialog_sua_ban_ghi(ban_ghi, 'loai_dich_vu_modal')"></a>
