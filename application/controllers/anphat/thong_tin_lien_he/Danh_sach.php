...
{
  public function execute($luoc_do = 'thong_tin_lien_he')
  {
    ...
    $data = [
      ...
      'model_nut_nhap_du_lieu' => 'chuyen_trang(\'/thong_tin_lien_he/nhap_du_lieu\')()',
      'model_nut_xuat_du_lieu' => 'chuyen_trang(\'/thong_tin_lien_he/xuat_du_lieu\')()',
      'du_lieu_tai_tu_dong' => [
        [
