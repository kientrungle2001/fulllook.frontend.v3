	...
	<div class="container mt-4 mb-3">
		<div class="main-shadow full p-3">
			...
			<div class="tab-content pt-2  mb-5" id="myTabContent">
			  	<div class="tab-pane fade in active bg-light" id="mucdich" role="tabpanel" aria-labelledby="mucdich-tab" ng-bind-html="tabs.proposal">
			  	</div>
			    ...
			    <div class="mb-3 text-center">
			      ...
			      <form style="width: 60%; margin: 0px auto;" id="paycardflForm" method="post">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" ng-model="paycard.coupon" placeholder="Mã giảm giá (nếu có)">
						</div>						
			            ...
			            <input type="submit" class="btn btn-danger" ng-click="payCardFl('//<?php echo $_SERVER['HTTP_HOST'] ?>')" value=" NẠP THẺ">
			      </form>				
			</div>
