...
?>
<div class="item_cate2 h-product" itemtype="http://schema.org/Product">
		<a href="<?= $links_model->get_product_category_link($language, $cat, $fourth_category)?>">
		...
		<h3><a href="<?= $links_model->get_product_category_link($language, $cat, $fourth_category)?>" class="name_cate2 p-name"><?= wpglobus($cat['name'], $language)  ?></a></h3>
		<br clear="all">
	</div>
<?php
endforeach;
