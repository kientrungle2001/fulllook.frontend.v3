<div>
	<div class="container-fluid">
				...
				<div class="nobel-list-md choice">
					<div class="row">
						<div class="col-xs-12" ng-show="language != 'vn'">
							<div class="ptnn-title full text-justify" mathjax-bind="question.name"></div>
						</div>
						<div class="col-xs-12" ng-show="language == 'vn' || language == 'ev'">
							<div class="ptnn-title full text-justify" mathjax-bind="question.name_vn"></div>
						</div>
					</div>
		...
		<div class="text-center full mb-3 relative">				
			<button id="finish-choice" class="btn btn-primary btt-practice " name="finish-choice" ng-click="finishPractice()" ng-disabled="!remaining.running"><span class="fa fa-check"></span>
				Hoàn thành
			</button>
