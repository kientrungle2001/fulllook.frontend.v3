...
$child_categories = $terms_model->get_children($second_section_category);
...
<?php 
	...
	$jsonlds[] = array(
		...
		"url"	=> $links_model->get_product_link($language, $second_category, $post),
	...
	<div class="item_cate2 h-product" itemtype="http://schema.org/Product">
		...
		<h3><a href="<?= $links_model->get_product_link($language, $second_category, $post)?>" class="name_cate2 p-name"><?= wpglobus($post['post_title'], $language)  ?></a></h3>
		<br clear="all">
	</div>
<?php endforeach;
endif;
...
<script type="application/ld+json">
{
    ...
    "@type": "ItemList",
    "url": "<?= $links_model->get_product_category_link($language, $second_category)?>",
    "numberOfItems": "3",
