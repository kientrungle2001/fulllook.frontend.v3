...
<table class="table table-sm table-bordered">
  <tr>
    <th>ID</th>
    <th>Tên danh sách khai thác</th>
    <th>Mã danh sách khai thác</th>
  ...
  <tr ng-repeat="ban_ghi in danh_sach_ban_ghi">
    <td>{{$index + 1}}</td>
    <td>{{ban_ghi.ten_danh_sach_khai_thac}}</td>
    <td>{{ban_ghi.ma_danh_sach_khai_thac}}</td>
    ...
    <td>
      <a href="#" class="fa fa-pencil text-primary" ng-click="mo_dialog_sua_ban_ghi(ban_ghi, 'danh_sach_khai_thac_modal')"></a>
