<?php
if ($c->has_view($module . '/hanh_dong')) :
  $c->view($module . '/hanh_dong', $data);
endif;
$c->view('tong_quat/phan_trang');
?>
<table class="table table-sm table-bordered">
  ...
  <tr ng-repeat="ban_ghi in danh_sach_ban_ghi">
    ...
    <?php endforeach; ?>
    <td><a href="#" class="fa fa-circle" ng-class="{'text-success': ban_ghi.trang_thai, 'text-dark': !ban_ghi.trang_thai}" ng-click="thay_doi_trang_thai(ban_ghi)"></a></td>
    <td>
