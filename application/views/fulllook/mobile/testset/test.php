...
<div class="do-practice full" style="text-align: center; padding-top: 50px;">
	...
	<div ng-show="checkIsLogedIn()">
		...
		<div ng-show="test.trial == 1 || checkIsPaid()">
			<a href="/testSet/{{test.trytest==2 ? 'writting': 'doing'}}?category_id={{category_id}}&test_set_id={{test_set_id}}&test_id={{test_id}}" class="btn btn-danger btn-lg fa fa-play fa-3x text-white"> Bắt đầu làm</a>
		</div>
	</div>
