...
<?php foreach ($posts as $post) :
	...
	?>
	<div class="item_cate2 h-product">
		...
		<a href="<?= $links_model->get_product_link($language, $first_category, $post)?>" class="name_cate2 p-name"><?= wpglobus($post['post_title'], $language)  ?></a>
		<br clear="all">
	</div>
<?php endforeach; ?>
